...
) ENGINE = InnoDB AUTO_INCREMENT = 5106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '股票历史数据表-扩展版' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '股票信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `technical_indicators`  (
  ...
  `macd` decimal(10, 4) NULL DEFAULT NULL COMMENT 'MACD指标',
  `rsi` decimal(10, 4) NULL DEFAULT NULL COMMENT 'RSI指标',
  `kdj_k` decimal(10, 4) NULL DEFAULT NULL COMMENT 'KDJ-K值',
  `kdj_d` decimal(10, 4) NULL DEFAULT NULL COMMENT 'KDJ-D值',
  `kdj_j` decimal(10, 4) NULL DEFAULT NULL COMMENT 'KDJ-J值',
  `boll_upper` decimal(10, 2) NULL DEFAULT NULL COMMENT '布林线上轨',
  `boll_middle` decimal(10, 2) NULL DEFAULT NULL COMMENT '布林线中轨',
  `boll_lower` decimal(10, 2) NULL DEFAULT NULL COMMENT '布林线下轨',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_stock_indicator_date`(`stock_id` ASC, `indicator_date` ASC) USING BTREE,
  CONSTRAINT `technical_indicators_ibfk_1` FOREIGN KEY (`stock_id`) REFERENCES `stock_info` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '技术指标表' ROW_FORMAT = Dynamic;
