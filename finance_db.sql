...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI模型配置表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '回测结果表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '公司概况表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '投资建议表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '投资偏好表-支持预设和自定义投资期限' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '提示词迭代日志表-支持AI自动优化闭环' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '股东信息表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '持股结构表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for stock_backtest_detail
-- ----------------------------
DROP TABLE IF EXISTS `stock_backtest_detail`;
CREATE TABLE `stock_backtest_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '详情ID',
  `backtest_id` bigint NOT NULL COMMENT '回测结果ID',
  `advice_id` bigint NOT NULL COMMENT '投资建议ID',
  `backtest_period` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '回测周期:1M/3M/6M/1Y',
  `stock_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '股票代码',
  `stock_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '股票名称',
  `suggested_action` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '操作建议',
  `total_return` decimal(10, 4) NULL DEFAULT NULL COMMENT '总收益率(%)',
  `max_drawdown` decimal(10, 4) NULL DEFAULT NULL COMMENT '最大回撤(%)',
  `trade_count` int NULL DEFAULT 0 COMMENT '交易次数',
  `win_count` int NULL DEFAULT 0 COMMENT '盈利次数',
  `entry_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '实际买入价格',
  `exit_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '实际卖出价格',
  `exit_reason` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '卖出原因',
  `no_trade_reason` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '未交易原因',
  `risk_level` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '风险等级:LOW/MEDIUM/HIGH/EXTREME',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_backtest_id`(`backtest_id` ASC) USING BTREE,
  INDEX `idx_advice_id`(`advice_id` ASC) USING BTREE,
  CONSTRAINT `fk_stock_backtest_advice` FOREIGN KEY (`advice_id`) REFERENCES `investment_advice` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `fk_stock_backtest_backtest` FOREIGN KEY (`backtest_id`) REFERENCES `backtest_result` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 101 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '单只股票回测详情表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 659114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '股票历史数据表-扩展版' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for structured_advice
-- ----------------------------
DROP TABLE IF EXISTS `structured_advice`;
CREATE TABLE `structured_advice`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '结构化建议ID',
  `advice_id` bigint NOT NULL COMMENT '投资建议ID',
  ...
  `suggested_action` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作建议:BUY-买入,SELL-卖出,HOLD-持有,NOT_RECOMMENDED-不建议',
  `thesis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '核心逻辑/原因',
  `entry_price_start` decimal(10, 2) NULL DEFAULT NULL COMMENT '建议入场价格区间-开始',
  `entry_price_end` decimal(10, 2) NULL DEFAULT NULL COMMENT '建议入场价格区间-结束',
  `take_profit_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '止盈价格',
  `stop_loss_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '止损价格',
  `advice_effective_days` int NULL DEFAULT NULL COMMENT '建议有效期(天)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_advice_id`(`advice_id` ASC) USING BTREE,
  INDEX `idx_stock_code`(`stock_code` ASC) USING BTREE,
  CONSTRAINT `fk_structured_advice_advice` FOREIGN KEY (`advice_id`) REFERENCES `investment_advice` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '结构化投资建议表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户自选股表' ROW_FORMAT = DYNAMIC;
